...
android {
  namespace = "io.github.mapvina.compose.demoapp"

  defaultConfig {
    applicationId = "io.github.mapvina.compose.demoapp"
...
kotlin {
  ...
  sourceSets {
    ...
    commonMain.dependencies {
      ...
      implementation(project(":lib:mapvina-compose")) {
        exclude(group = "io.github.mapvina", module = "android-sdk")
      }
      implementation(project(":lib:mapvina-compose-material3")) {
        exclude(group = "io.github.mapvina", module = "android-sdk")
      }
    }
    ...
    androidMain {
      ...
      dependencies {
        ...
        implementation(project(":lib:mapvina-compose-gms")) {
          exclude(group = "io.github.mapvina", module = "android-sdk")
        }

        project.properties["demoAppMapvinaAndroidFlavor"].let { flavor ->
          when (flavor) {
            null,
            "default" -> implementation(libs.mapvina.android)
            "opengl" -> implementation(libs.mapvina.androidOpenGL)
            "vulkan" -> implementation(libs.mapvina.androidVulkan)
            "debug" -> implementation(libs.mapvina.androidDebug)
            else -> error("Unknown mapvina android flavor: $flavor")
          }
        }
      }
    }
    ...
    desktopMain.apply {
      ...
      dependencies {
        ...
        runtimeOnly(project(":lib:mapvina-native-bindings-jni")) {
          capabilities {
            requireCapability(
              "io.github.mapvina.compose:mapvina-native-bindings-jni-${Configuration(project).hostOsArchRendererTriplet}"
            )
          }
        }
      }
...
compose.resources { packageOfResClass = "io.github.mapvina.compose.demoapp.generated" }

composeCompiler { reportsDestination = layout.buildDirectory.dir("compose/reports") }

compose.desktop {
  application {
    mainClass = "io.github.mapvina.compose.demoapp.MainKt"

    nativeDistributions {
      targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
      packageName = "io.github.mapvina.compose.demoapp"
