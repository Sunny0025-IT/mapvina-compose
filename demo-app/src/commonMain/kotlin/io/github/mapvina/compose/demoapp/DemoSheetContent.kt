...
import io.github.mapvina.compose.demoapp.design.CloseButton
import io.github.mapvina.compose.demoapp.design.Heading
import io.github.mapvina.compose.demoapp.design.PageColumn
import io.github.mapvina.compose.demoapp.design.SelectableListItem
import io.github.mapvina.compose.demoapp.generated.Res
import io.github.mapvina.compose.demoapp.generated.filter_center_focus_24px
import io.github.mapvina.compose.demoapp.generated.visibility_24px
import io.github.mapvina.compose.demoapp.generated.visibility_off_24px
...
fun DemoSheetContent(state: DemoState, modifier: Modifier) {
  NavHost(
    ...
    composable("MAIN_MENU") {
      PageColumn(modifier) {
        Heading(text = "MapVina Compose Demos")
