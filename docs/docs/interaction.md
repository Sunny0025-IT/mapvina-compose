...
-8<- "demo-app/src/androidMain/kotlin/io/github/mapvina/compose/docsnippets/Interaction.kt:common-gesture-ornament"
```
...
-8<- "demo-app/src/androidMain/kotlin/io/github/mapvina/compose/docsnippets/Interaction.kt:gesture-settings"
```
...
these ornaments. They're implemented by the underlying MapVina SDK, so may
render differently on different platforms and the available options vary by
platform.

```kotlin title="map.android.kt"
-8<- "demo-app/src/androidMain/kotlin/io/github/mapvina/compose/docsnippets/Interaction.kt:ornament-settings"
```

1. Insets the ornaments; useful if you have an edge-to-edge map or some UI
   elements that cover part of the map.
2. Displays a MapVina logo
...
```kotlin
-8<- "demo-app/src/androidMain/kotlin/io/github/mapvina/compose/docsnippets/Interaction.kt:camera"
```
...
```kotlin
-8<- "demo-app/src/androidMain/kotlin/io/github/mapvina/compose/docsnippets/Interaction.kt:camera-animate"
```
...
```kotlin
-8<- "demo-app/src/androidMain/kotlin/io/github/mapvina/compose/docsnippets/Interaction.kt:click-listeners"
```
