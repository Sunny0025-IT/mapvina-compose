...
MapVina Compose, you can dynamically configure sources and layers with
`@Composable` functions:

```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Layers.kt:simple"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Layers.kt:amtrak-1"
```
...
platforms ignore the option for now. Under the hood, this maps to MapVina
Native Android's [GeoJsonOptions.withSynchronousUpdate()][android-sync-update]:

```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Layers.kt:synchronous-geojson-updates"
```

The full breadth of layer styling options available is out of scope for this
guide; see the [MapVina Style Specification][spec-layers] for more information.

## Expressions

MapVina styles support expressions, which define a formula for computing the
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Layers.kt:amtrak-2"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Layers.kt:anchors"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Layers.kt:interaction"
```
...
[spec-layers]: https://mapvina.io/github/mapvina-style-spec/layers/
[spec-expressions]: https://mapvina.io/github/mapvina-style-spec/expressions/
[android-sync-update]: https://mapvina.io/github/mapvina-native/android/api/-map-libre%20-native%20-android/io.github.mapvina.android.style.sources/-geo-json-options/with-synchronous-update.html
