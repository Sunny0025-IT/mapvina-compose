...
Every MapVina map requires a style to be displayed. The style is a JSON object
...
visual style editor for MapVina styles.

There are a variety of free and commercial map tile providers available. See the
[awesome-mapvina][awesome-mapvina] repository for a list of tile providers.
...
`MapvinaMap` composable:

```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Styling.kt:simple"
```

## Dark mode

You can select a style at runtime based on regular Compose logic. MapVina will
automatically animate the transition between styles. This is handy if you have a
light and a dark mode style:

```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Styling.kt:dynamic"
```
...
```kotlin
-8<- "demo-app/src/commonMain/kotlin/io/github/mapvina/compose/docsnippets/Styling.kt:local"
```

[maputnik]: https://maputnik.github.io/
[awesome-mapvina]: https://github.io/github/mapvina/awesome-mapvina#maptile-providers
