...
import io.github.mapvina.android.plugins.scalebar.ScaleBarOptions
import io.github.mapvina.android.plugins.scalebar.ScaleBarPlugin

internal class AndroidScaleBar(ctx: Context, private val mapView: MapView, map: MapVinaMap) {
