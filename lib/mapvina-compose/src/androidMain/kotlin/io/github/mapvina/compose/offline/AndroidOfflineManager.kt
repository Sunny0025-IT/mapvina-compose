...
import io.github.mapvina.android.offline.OfflineManager as MLNOfflineManager
...
internal class AndroidOfflineManager @UiThread internal constructor(context: Context) :
  ...
  private val impl =
    {
      MapVina.getInstance(context) // must be called before getting OfflineManager instance
  ...
  override suspend fun create(
    ...
    metadata: ByteArray,
  ): io.github.mapvina.compose.offline.OfflinePack =
  ...
  override fun resume(pack: io.github.mapvina.compose.offline.OfflinePack) =
    pack.impl.setDownloadState(OfflineRegion.STATE_ACTIVE)

  override fun pause(pack: io.github.mapvina.compose.offline.OfflinePack) =
    pack.impl.setDownloadState(OfflineRegion.STATE_INACTIVE)

  override suspend fun delete(pack: io.github.mapvina.compose.offline.OfflinePack): Unit =
    suspendCoroutine { continuation ->
        pack.impl.delete(
