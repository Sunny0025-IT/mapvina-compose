 ...
 *
 * It defines how to resolve certain expressions (TextUnit, bitmaps) to their MapVina counterparts.
 * MapVina Compose users should not need to implement this interface; it is used internally by the
 * MapVina Compose library.
 */
