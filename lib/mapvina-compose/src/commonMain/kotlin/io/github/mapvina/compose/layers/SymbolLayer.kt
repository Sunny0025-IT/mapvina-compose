...
import io.github.mapvina.compose.expressions.dsl.div
...
import io.github.mapvina.compose.expressions.value.FormattedValue
import io.github.mapvina.compose.expressions.value.IconPitchAlignment
import io.github.mapvina.compose.expressions.value.IconRotationAlignment
import io.github.mapvina.compose.expressions.value.IconTextFit
...
import io.github.mapvina.compose.expressions.value.SymbolOverlap
import io.github.mapvina.compose.expressions.value.SymbolPlacement
import io.github.mapvina.compose.expressions.value.SymbolZOrder
import io.github.mapvina.compose.expressions.value.TextJustify
import io.github.mapvina.compose.expressions.value.TextPitchAlignment
import io.github.mapvina.compose.expressions.value.TextRotationAlignment
import io.github.mapvina.compose.expressions.value.TextTransform
import io.github.mapvina.compose.expressions.value.TextUnitOffsetValue
import io.github.mapvina.compose.expressions.value.TextUnitValue
import io.github.mapvina.compose.expressions.value.TextVariableAnchorOffsetValue
import io.github.mapvina.compose.expressions.value.TextWritingMode
...
private const val ASSUMED_SP = 16f // MapVina's default text size
 ...
 *   levels. The [featureState][io.github.mapvina.compose.expressions.dsl.Feature.state] expression is
 ...
 *   [mapvina-native#251](https://github.io/github/mapvina/mapvina-native/issues/251)**
 *
 ...
 *   [format][io.github.mapvina.compose.expressions.dsl.format].
 *
 ...
 *   units. This is a limitation of the MapVina expression parser. If text size does not use zoom
 ...
 * https://github.io/github/mapvina/mapvina-compose/issues/143
 *
 ...
 *   map. See [SymbolOverlap][io.github.mapvina.compose.expressions.value.SymbolOverlap]. Overrides
 *   [textAllowOverlap].
 *
 *   Ignored if [textField] is not specified.
 *
...
public fun SymbolLayer(
  ...
  // Scaling code will need changes after https://github.io/github/mapvina/mapvina-native/issues/3057.
