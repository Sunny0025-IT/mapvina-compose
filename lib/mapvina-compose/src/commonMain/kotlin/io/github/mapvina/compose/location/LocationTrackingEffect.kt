...
/**
 * Provides an easy mechanism to keep a map's [io.github.mapvina.compose.camera.CameraState] in sync with
...
public interface LocationChangeScope {
  ...
  /**
   * Convenience method for updating a [io.github.mapvina.compose.camera.CameraState] based on this
   * location change
   *
   * @param animationDuration if `null` updates [io.github.mapvina.compose.camera.CameraState.position]
