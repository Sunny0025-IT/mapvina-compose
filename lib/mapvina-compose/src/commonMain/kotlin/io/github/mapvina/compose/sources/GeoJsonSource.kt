 ...
 *
 *   See the [MapVina Style Spec](https://mapvina.io/github/mapvina-style-spec/sources/#cluster) for
 *   details.
 *
 ...
 *   [LineLayer][io.github.mapvina.compose.layers.LineLayer]s that specify a `gradient`.
 ...
 *   [#738](https://github.io/github/mapvina/mapvina-compose/issues/738#issuecomment-3716900291).
 */
@Immutable
public data class GeoJsonOptions(
  ...
  public data class ClusterPropertyAggregator<T : ExpressionValue>(
     ...
     * [io.github.mapvina.compose.expressions.dsl.Feature.accumulated] will return the value accumulated
