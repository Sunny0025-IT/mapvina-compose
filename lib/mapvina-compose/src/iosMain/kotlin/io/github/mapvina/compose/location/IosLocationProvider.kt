...
public class IosLocationProvider(
  ...
  private inner class Delegate(private val channel: SendChannel<ProviderUpdate>) :
    ...
    override fun locationManager(manager: CLLocationManager, didUpdateLocations: List<*>) {
      ...
      locations?.forEach { channel.trySend(ProviderUpdate.LocationUpdate(it.asMapVinaLocation())) }
    }

    override fun locationManager(manager: CLLocationManager, didUpdateHeading: CLHeading) {
      channel.trySend(ProviderUpdate.OrientationUpdate(didUpdateHeading.asMapVinaOrientation()))
    }
...
private fun CLHeading.asMapVinaOrientation(): Orientation {
