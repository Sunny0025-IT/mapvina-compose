...
import MapVina.MLNOfflinePack
import MapVina.MLNOfflinePackErrorNotification
import MapVina.MLNOfflinePackMaximumMapboxTilesReachedNotification
import MapVina.MLNOfflinePackProgressChangedNotification
import MapVina.MLNOfflinePackUserInfoKeyError
import MapVina.MLNOfflinePackUserInfoKeyMaximumCount
import MapVina.MLNOfflineStorage
...
import io.github.mapvina.compose.util.KVObserverProtocol
 ...
 * [io.github.mapvina.compose.offline.rememberOfflineManager].
 */
...
internal object IosOfflineManager : OfflineManager {
  ...
  override suspend fun create(
    ...
    metadata: ByteArray,
  ): io.github.mapvina.compose.offline.OfflinePack = suspendCoroutine { continuation ->
  ...
  override fun resume(pack: io.github.mapvina.compose.offline.OfflinePack) = pack.impl.resume()

  override fun pause(pack: io.github.mapvina.compose.offline.OfflinePack) = pack.impl.suspend()

  override suspend fun delete(pack: io.github.mapvina.compose.offline.OfflinePack) =
  ...
  override suspend fun invalidate(pack: io.github.mapvina.compose.offline.OfflinePack) =
    suspendCoroutine { continuation ->
