...
import MapVina.MLNShapeSource
import MapVina.MLNShapeSourceOptionBuffer
import MapVina.MLNShapeSourceOptionClusterMinPoints
import MapVina.MLNShapeSourceOptionClusterProperties
import MapVina.MLNShapeSourceOptionClusterRadius
import MapVina.MLNShapeSourceOptionClustered
import MapVina.MLNShapeSourceOptionLineDistanceMetrics
import MapVina.MLNShapeSourceOptionMaximumZoomLevel
import MapVina.MLNShapeSourceOptionMaximumZoomLevelForClustering
...
import io.github.mapvina.compose.util.toMLNPointFeatureCluster
...
public actual class GeoJsonSource : Source {
  ...
  private fun buildOptionMap(options: GeoJsonOptions) =
    buildMap<Any?, Any?> {
      ...
      // See https://github.io/github/mapvina/mapvina-compose/issues/738#issuecomment-3716900291
    }
