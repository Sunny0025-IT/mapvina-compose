...
import io.github.mapvina.compose.style.JsStyle
import io.github.mapvina.compose.util.VisibleRegion
import io.github.mapvina.compose.util.toBoundingBox
import io.github.mapvina.compose.util.toControlPosition
import io.github.mapvina.compose.util.toDpOffset
import io.github.mapvina.compose.util.toLatLngBounds
import io.github.mapvina.compose.util.toLngLat
import io.github.mapvina.compose.util.toPaddingOptions
import io.github.mapvina.compose.util.toPaddingValuesAbsolute
import io.github.mapvina.compose.util.toPoint
import io.github.mapvina.compose.util.toPosition
import io.github.mapvina.kmp.js.controls.AttributionControl
import io.github.mapvina.kmp.js.controls.FullscreenControl
import io.github.mapvina.kmp.js.controls.GeolocateControl
import io.github.mapvina.kmp.js.controls.GlobeControl
import io.github.mapvina.kmp.js.controls.LogoControl
import io.github.mapvina.kmp.js.controls.NavigationControl
import io.github.mapvina.kmp.js.controls.NavigationControlOptions
import io.github.mapvina.kmp.js.controls.ScaleControl
import io.github.mapvina.kmp.js.event.MapVinaEvent
import io.github.mapvina.kmp.js.event.MapMouseEvent
import io.github.mapvina.kmp.js.geometry.LngLat
import io.github.mapvina.kmp.js.geometry.Point
import io.github.mapvina.kmp.js.map.EaseToOptions
import io.github.mapvina.kmp.js.map.FitBoundsOptions
import io.github.mapvina.kmp.js.map.JumpToOptions
import io.github.mapvina.kmp.js.map.Map
import io.github.mapvina.kmp.js.map.MapOptions
import io.github.mapvina.kmp.js.map.QueryRenderedFeaturesOptions
...
internal class JsMapAdapter(
  ...
  init {
    ...
    impl.on("movestart") {
      val event = it.unsafeCast<MapVinaEvent<Any?>>()
