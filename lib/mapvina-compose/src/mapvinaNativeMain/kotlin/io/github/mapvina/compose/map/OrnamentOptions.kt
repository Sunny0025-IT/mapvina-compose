 ...
 * @param isLogoEnabled Determines if the MapVina logo is displayed.
 * @param logoAlignment Specifies the location of the MapVina logo. On Android, only the four
