 ...
 *
 * [See MapVina Style Spec.](https://mapvina.io/github/mapvina-style-spec/sources/#vector)
 */
public external interface VectorSourceSpecification : SourceSpecification {
   ...
   * included in a source, no tiles outside of given bounds are requested by MapVina. Defaults to
   ...
   * - `"mlt"`: MapVina Vector Tiles. See https://github.io/github/mapvina/mapvina-tile-spec for more
   *   info.
   */
