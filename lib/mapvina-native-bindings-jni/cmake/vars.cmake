...
set(mapvina-native_SOURCE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/vendor/mapvina-native")

if(WIN32)
    set(CMAKE_TOOLCHAIN_FILE ${mapvina-native_SOURCE_DIR}/platform/windows/custom-toolchain.cmake)
endif()
