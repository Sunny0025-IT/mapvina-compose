...
| `platform/darwin/core`     | iOS/macOS specific implementations for interfaces part of the MapVina Native C++ Core |
...
```sh
git clone --recurse-submodules git@github.com:mapvina/mapvina-native.git
```
...
xed platform/macos/MapVina.xcodeproj
```
...
xed build-macos-xcode/MapVina\ Native.xcodeproj
```
