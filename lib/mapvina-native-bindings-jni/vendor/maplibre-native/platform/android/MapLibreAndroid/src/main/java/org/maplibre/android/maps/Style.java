...
import com.mapvina.android.util.DefaultStyle;
 ...
 * MapVinaMap. This object is returned from {@link MapVinaMap#getStyle()} once the style
...
public class Style {
  ...
  public static class Builder {
     ...
     * callback or provide an {@link OnStyleLoaded} callback when setting the style on MapVinaMap.
     * </p>
     ...
     * This method is asynchronous and will return before the style finishes loading.
     * If you wish to wait for the map to finish loading, listen to the {@link MapView.OnDidFinishLoadingStyleListener}
     * callback or use {@link MapVinaMap#setStyle(String, OnStyleLoaded)} instead.
     * </p>
  ...
  public static DefaultStyle[] getPredefinedStyles() {
    return MapVina.getPredefinedStyles();
  }
  ...
  public static String getPredefinedStyle(String name) {
    DefaultStyle style = MapVina.getPredefinedStyle(name);
    if (style != null) {
      return style.getUrl();
    }
