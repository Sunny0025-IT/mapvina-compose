package com.mapvina.android.snapshotter
...
import com.mapvina.android.R
import com.mapvina.android.attribution.AttributionLayout
import com.mapvina.android.attribution.AttributionMeasure
import com.mapvina.android.attribution.AttributionParser
...
import com.mapvina.android.maps.Image
import com.mapvina.android.maps.Style
import com.mapvina.android.maps.Style.Builder.*
...
import com.mapvina.android.utils.FontUtils
import com.mapvina.android.utils.ThreadUtils
...
open class MapSnapshotter(context: Context, options: Options) {
    ...
    class Options(width: Int, height: Int) {
         ...
         * Default font for local ideograph font family is [MapVinaConstants.DEFAULT_FONT].
         */
        var localIdeographFontFamily = MapVinaConstants.DEFAULT_FONT
            private set
        ...
        /**
         * @param showLogo The flag indicating to show the MapVina logo.
         * @return the mutated [Options]
         */
    ...
    private fun createTextView(mapSnapshot: MapSnapshot, shortText: Boolean, scale: Float): TextView {
        val textColor = ResourcesCompat.getColor(context.resources, R.color.mapvina_gray_dark, context.theme)
        ...
        textView.setBackgroundResource(R.drawable.mapvina_rounded_corner)
    ...
    private fun createScaledLogo(snapshot: Bitmap): Logo {
        val logo = context.resources.getDrawable(R.drawable.mapvina_logo_icon, null)?.toBitmap()!!
            ...
            if (builder != null) {
                ...
                for (layerWrapper in builder.layers) {
                    if (layerWrapper is LayerAtWrapper) {
                        ...
                        addLayerBelow(layerWrapper.layer, MapVinaConstants.LAYER_ID_ANNOTATIONS)
                    }
                }
