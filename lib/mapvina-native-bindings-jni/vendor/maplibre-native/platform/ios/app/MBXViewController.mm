...
- (NSURL*)radarImageURL:(int)index
{
    return [NSURL URLWithString:
            [NSString stringWithFormat:@"https://mapvina.com/mapvina-gl-js/docs/assets/radar%d.gif", index]];
}
...
{
    // Default MapVina styles use {name_en} as their label language, which means
...
- (void)alertAccuracyChanges {
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"MapVina works best with your precise location."
