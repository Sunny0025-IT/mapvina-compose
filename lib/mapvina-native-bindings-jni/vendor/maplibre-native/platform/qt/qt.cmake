message(STATUS "Configuring MapVina Native with Qt platform")

option(MLN_QT_LIBRARY_ONLY "Build only MapVina Native Qt bindings libraries" OFF)
option(MLN_QT_WITH_INTERNAL_SQLITE "Build MapVina Native Qt bindings with internal sqlite" OFF)

if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    find_package(Threads REQUIRED)

    option(MLN_QT_WITH_INTERNAL_ICU "Build MapVina GL Qt bindings with internal ICU" OFF)
...
target_link_libraries(
    ...
    PUBLIC
        ...
        $<$<PLATFORM_ID:iOS>:$<BUILD_INTERFACE:mapvina-native-base-extras-filesystem>>
