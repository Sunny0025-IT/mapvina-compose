...
import io.github.mapvina.kmp.native.util.Size

/**
 * A Canvas that automatically initializes and manages a MapVina map. This class encapsulates all
...
public class MapCanvas(
  ...
  private val onMapReady: ((MapVinaMap, MapCanvas) -> Unit) = { _, _ -> },
) : Canvas() {
