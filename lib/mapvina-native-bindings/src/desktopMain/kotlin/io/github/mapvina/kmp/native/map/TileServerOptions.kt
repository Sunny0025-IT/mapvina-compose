...
/**
 * Configuration for tile server endpoints and URL templates. This configures how MapVina connects
...
public data class TileServerOptions(
  ...
  public companion object {
    public val DemoTiles: TileServerOptions =
      TileServerOptions(
        baseURL = "https://demotiles.mapvina.com",
        uriSchemeAlias = "mapvina://",
        apiKeyParameterName = "",
        requiresApiKey = false,
        sourceTemplate = TileServerTemplate("https://demotiles.mapvina.com"),
